...
document.addEventListener('DOMContentLoaded', function() {
 ...
 if (targetHref && targetHref.startsWith('#')) {
            e.preventDefault(); // Solo prevenir el comportamiento por defecto para enlaces de ancla
            ...
            // Si es un enlace externo o ruta, navegar después de un breve delay
            e.preventDefault(); // Prevenir navegación inmediata
            showToast(`Navegando a: ${sectionTitles[section]}`, 'info');
            
            setTimeout(() => {
                window.location.href = targetHref;
            }, 800); // Pequeño delay para que se vea el toast
        } else {
            // Si no hay href, solo mostrar notificación
            showToast(`Navegando a: ${sectionTitles[section]}`, 'info');
        }
